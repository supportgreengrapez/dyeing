...
<div class="container">
  <h2 style="color:#f9a848; text-align:center; margin-top:10px;"><strong>Received for Dyeing Form</strong></h2>
  <div class="clearfix"></div>
  <form method="post" action="{{url('/')}}/received/dyeing/data" enctype="multipart/form-data">
    @if($errors->any())
    ...
    <div class="row">
      <div class="col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="form-group">
          <label>Part Lot No</label>
          <input type="text" class="form-control" name="party_lot_no">
        </div>
        <div class="form-group">
          <label>Remarks</label>
  ...
  <div class="modal-dialog"> 
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Received From Name</h4>
      </div>
