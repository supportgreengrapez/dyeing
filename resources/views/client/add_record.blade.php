...
<!--/ menu -->
<div class="container">
  <h2 style="color:#f9a848; text-align:center; margin-top:10px;"><strong>Add Records</strong></h2>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form_main">
          <div class="form">
            <label>Bilty#</label>
            <input type="number"   placeholder="" value="0" name="bilty_number" class="txt">
            <label>Sender Company</label>
            <input type="text"  placeholder="" value=" " name="sender_company" class="txt"   maxlength="50">
            <label>Sender City</label>
            <select class="selectpicker form-control" data-show-subtext="true" name="sender_city"  data-live-search="true">
            ...
            <input type="number"  placeholder="" value="" name="bundles" class="txt">
            <label>Date Of Booking</label>
            <input type="date"  placeholder="" value="" name="date_of_booking" class=" txt date form-control" >
            <label>Date of Receiving</label>
            <input type="date"  placeholder="" value="" name="date_of_receiving" class="txt date form-control">
            <label>Goods Company</label>
            <input type="text"  placeholder="" value="" name="goods_company" class="txt"   maxlength="50">
            <label>Quantity</label>
            <input type="number"  placeholder="" value="" name="quantity" class="txt"   step="0.00001" maxlength="50">
            <div class="form-group">
              <label for="sel1">Bilty Type In OR Out</label>
      ...
      <div class="col-md-6">
        <div class="form_main">
          <div class="form">
            ...
            <input type="text"  placeholder="" value="" name="bilty_charges" class="txt">
            <label>Receiver Company</label>
            <input type="text"  placeholder="" value="" name="receiver_company" class="txt"  pattern="[a-zA-Z0-9\s]+" maxlength="50">
            <label>Receiver City</label>
                <select class="selectpicker form-control" data-show-subtext="true"  name="receiver_city"  data-live-search="true">
              <option value="">Select City</option>
              <option value="Ahmadpur East">Ahmadpur East</option>
              <option value="Ahmadpur Sial">Ahmadpur Sial</option>
              <option value="Alipur">Alipur</option>
            ...
            <label>Notes</label>
            <input type="text"  placeholder="" value="" name="notes" class="txt"  maxlength="200">
            <label>Charge To</label>
            <input type="text"  placeholder="" value="" name="charge_to" class="txt" pattern="[a-zA-Z0-9\s]+" maxlength="100">
            <label>To Record</label>
            <input type="text"  placeholder="" value="" name="to_record" class="txt" pattern="[a-zA-Z0-9\s]+" maxlength="100">
            <label>Description</label>
            <textarea  placeholder="" value="" name="description" class="txt" rows="6"   maxlength="1000"> </textarea>
          </div>
        </div>
      </div>
    </div>
