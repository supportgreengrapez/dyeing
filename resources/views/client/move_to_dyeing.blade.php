...
<div class="container">
  <h2 style="color:#f9a848; text-align:center; margin-top:10px;"><strong>Issue Dyeing</strong></h2>
  ...
  @foreach($result as $results)
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="received_from" value="{{$results->recieved_from}}" readonly>
        </div>
        @endforeach
                            @endif
        <div class="form-group">
  ...
  @foreach($result as $results)
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="dyeing_lot" value="{{$results->pk_id}}" readonly>
        </div>
        <div class="form-group">
          <label>Folding</label>
